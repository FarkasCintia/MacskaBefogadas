        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="row g-3 needs-validation" novalidate>
              <!-- nev -->
              <div class="col-md-3">
                <label for="oltasNev" class="form-label">oltasNev</label>
                <input
                  type="text"
                  class="form-control"
                  id="oltasNev"
                  v-model="row.oltasNev"
                  required
                />
...
class Oltasok {
  constructor(
    ...
    this.oltasokId = oltasokId;
    this.oltasNev = oltasNev;
  }
}
...
export default {
  ...
  methods: {
    ...
    updateRow() {
      ...
      let params = {
        query: "oltasokUpdate",
        oltasokId: this.row.oltasokId,
        oltasNev: this.row.oltasNev,
      };
      axios
        .post(this.url, params)
        .then((res) => {
