        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="row g-3 needs-validation" novalidate>
              <!-- nev -->
              <div class="col-md-3">
                <label for="fajtaNev" class="form-label">fajtaNev</label>
                <input
                  type="text"
                  class="form-control"
                  id="fajtaNev"
                  v-model="row.fajtaNev"
                  required
                />
